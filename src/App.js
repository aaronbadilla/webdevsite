    ...
    <div>
        ...
        <div className="portfolio">
          ...
          >
            <ProjectCard
              ...
              writtenWith="Written with: VanillaJS."
            ...
            <ProjectCard
              ...
              writtenWith="Written with: Node.js, Express, EJS"
            ...
            <ProjectCard
              ...
              writtenWith="Written with: Javascript, jQuery."
            ...
            <ProjectCard
              ...
              writtenWith="Written with: CSS, Bootstrap."
            ...
            <ProjectCard
              ...
              writtenWith="Written with: Javascript, Node.Js, EJS"
      ...
      <div className="skills" id="skills">
        ...
        <div className="skill-row">
          ...
          <p className="skill-description">
            My knowledge and experience with many coding languages,
            libraries, and frameworks allows me to build web applications that deliver an
            inspiring user experience and provide a wide range of server-side functionality.{" "}
          </p>
        </div>
        <div className="skill-row">
          ...
          <div>
            ...
            <p>
              ...
              clear, focused, and engaging ways of communicating ideas,
              emotions, and stories. These skills allow me to understand and integrate the needs
              and desires of clients, collaborators, and co-workers into clean and concise code.{" "}
            </p>
          </div>
        </div>
        <div className="employment-resources">
          ...
          <a
            href="https://www.linkedin.com/in/aaron-badilla-76076b144/"
            className="linkedin"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a href="https://twitter.com/aarondbadilla"
            target="_blank"
            rel="noopener noreferrer"
            className="twitter"
            >
        ...
        <div className="contact">
          <div className="explain-contact">
            ...
            <div className="email-cta">
              <h3>
                Need a web application built, want to collaborate, or just feel like saying
                hi? Don't hesitate to reach out!
              </h3>
            </div>
          </div>
      ...
      <div className="bottom-container">
        <div className="footer-link">
          ...
          <a
            className="footer-link"
            href="https://twitter.com/aarondbadilla"
            target="_blank"
            rel="noopener noreferrer"
            >
          ...
          <a
            className="footer-link"
            href="https://www.instagram.com/aaronbadilla/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="image-credit">
          <div>
            ...
            <a
              href="https://www.flaticon.com/free-icon/graphic-designer_3048189"
